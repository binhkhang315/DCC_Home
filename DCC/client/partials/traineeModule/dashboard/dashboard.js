...
myApp.factory('dashboardServices', ['$http', function($http) {
    ...
    var factoryDefinitions = {
      getTodaysStats: function() {
        return $http.get('partials/traineeModule/dashboard/mock/todays_stats.json').success(function(data) { return data; });
      },
	  getRecentNews: function() {
        return $http.get('partials/traineeModule/dashboard/mock/recent_news.json').success(function(data, status, headers, config) { return data; });
      },
	  getLastFiveCustomers: function() {
        return $http.get('partials/traineeModule/dashboard/mock/customers_last_five.json').success(function(data) { return data; });
      }
	}
