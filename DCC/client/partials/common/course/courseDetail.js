...
myApp.factory('courseDetailServices', ['$http', function($http) {
    ...
    var factoryDefinitions = {
        getCourseDetailById: function() {
            return $http.get('partials/common/course/mock/courseDetail.json').success(function(data) { return data; });
        },
...
//Controllers
myApp.controller('courseDetailCtrl', ['$scope', '$rootScope', 'courseDetailServices', function($scope, $rootScope, courseDetailServices) {
    //getCourseDetail
    $scope.courseDetail = {};
    courseDetailServices.getCourseDetailById().then(function(result){
