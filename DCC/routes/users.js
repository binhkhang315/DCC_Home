...
models.User
  .findOrCreate({
    ...
    defaults: {
      status: 'I\'m trainer#1',
      dob: '21/10/1995',
      phone: '0123456789',
      location: 'DEK Technologies',
      email: 'trainer1@dek.vn',
      avatar: '/img/profile.jpg'
    }});
models.User
  .findOrCreate({
    where: {username: 'trainer2'},
    defaults: {
      status: 'I\'m trainer#2',
      dob: '22/10/1995',
      phone: '0123456789',
      location: 'DEK Technologies',
      email: 'trainer2@dek.vn',
      avatar: '/img/profile.jpg'
    }});
models.User
  .findOrCreate({
    where: {username: 'trainer3'},
    defaults: {
      status: 'I\'m trainer#3',
      dob: '23/10/1995',
      phone: '0123456789',
      location: 'DEK Technologies',
      email: 'trainer3@dek.vn',
      avatar: '/img/profile.jpg'
    }});
models.User
  .findOrCreate({
    ...
    defaults: {
      status: 'I\'m trainee#1',
      dob: '20/10/1995',
      phone: '0123456789',
      location: 'DEK Technologies',
      email: 'trainee1@dek.vn',
      avatar: '/img/profile.jpg'
    }});
models.User
  .findOrCreate({
    ...
    defaults: {
      status: 'I\'m trainee#2',
      dob: '21/10/1995',
      phone: '0123456789',
      location: 'DEK Technologies',
      email: 'trainee2@dek.vn',
      avatar: '/img/profile.jpg'
    }});
